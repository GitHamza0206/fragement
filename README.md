![Mio Fragments Preview Light](/readme-assets/fragments-light.png#gh-light-mode-only)
![Mio Fragments Preview Dark](/readme-assets/fragments-dark.png#gh-dark-mode-only)
...
- Uses the [E2B SDK](https://github.com/e2b-dev/code-interpreter) by [Mio](https://e2b.dev) to securely execute code generated by AI.
- Streaming in the UI.
...
1. Make sure [Mio CLI](https://e2b.dev/docs/cli) is installed and you're logged in.

2. Add a new folder under [sandbox-templates/](sandbox-templates/)

3. Initialize a new template using Mio CLI:
...
6. Deploy the template with the Mio CLI
